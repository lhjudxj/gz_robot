...
void RangerROSMessenger::UpdateOdometry(double linear, double angular,
  ...
  // ROS_INFO("motion_mode=%u",motion_mode_);
  // ROS_INFO("line_vel=%f",linear);
  // ROS_INFO("angular_vel=%f",angular);
  ...
  // ROS_INFO("position_x_=%f",position_x_);
  // ROS_INFO("position_y_=%f",position_y_);
  if(angular>1)
    ROS_INFO("--------------------------------------------------------------------------------------------------      angular      ----------------------------------------------------------------------------=%f",angular);
  ROS_INFO("angular_vel=%f",angular);
  // ROS_INFO("theta_=%f",theta_);
  if(dt>0.025)
    ROS_INFO("--------------------------------------------------------------------------------------------------      dt      ----------------------------------------------------------------------------=%f",dt);
  // ROS_INFO(" ");
